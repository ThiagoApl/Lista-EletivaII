<?php $__env->startSection('title', 'Saídas no Estoque'); ?>
        ...
        <div class="w-full bg-gradient-to-br from-gray-900 via-gray-800 to-gray-700 rounded-2xl shadow-2xl p-6">
            ...
            <table class="table mb-8" style="background: rgba(30,32,48,0.98);">
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="color: #fff; font-weight: 500;"><?php echo e($output->product->name ?? '-'); ?></td>
                        <td style="color: #fff; font-weight: 500;"><?php echo e($output->reason); ?></td>
                        <td style="color: #fff; font-weight: 500;"><?php echo e($output->quantity); ?></td>
                        <td style="color: #fff; font-weight: 500;"><?php echo e($output->date); ?></td>
                        <td class="flex flex-row gap-2">
                            <a href="<?php echo e(route('stock-outputs.show', $output->id)); ?>" class="table-action no-bg view">Ver</a>
                            <a href="<?php echo e(route('stock-outputs.edit', $output->id)); ?>" class="table-action no-bg edit">Editar</a>
            ...
            <div id="saida-form" class="w-full flex flex-col items-center justify-center mt-8 hidden">
                <div class="card w-full max-w-md p-8 flex flex-col items-start shadow-2xl border border-gray-700 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-700">
                    ...
                    <form method="POST" action="<?php echo e(route('stock-outputs.store')); ?>" class="w-full">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Desktop\Projeto-Thiago\resources\views/stock_outputs/index.blade.php ENDPATH**/ ?>