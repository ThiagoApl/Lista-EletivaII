...
<?php $__env->startSection('title', 'Entradas no Estoque'); ?>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="flex flex-row gap-2">
                            <a href="<?php echo e(route('stock-entries.show', $entry->id)); ?>" class="table-action no-bg view">Ver</a>
                            <a href="<?php echo e(route('stock-entries.edit', $entry->id)); ?>" class="table-action no-bg edit">Editar</a>
                            <form action="<?php echo e(route('stock-entries.destroy', $entry->id)); ?>" method="POST" class="inline-block" onsubmit="return confirm('Confirma exclusão?')">
                                <?php echo csrf_field(); ?>
                        ...
                        <div class="mb-8 w-full">
                            ...
                            <select name="supplier_id" id="supplier_id" class="input bg-white/80 text-gray-900 placeholder-gray-400 shadow focus:bg-white w-full">
                                ...
                                <?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($supplier->id); ?>"><?php echo e($supplier->nome); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Desktop\Projeto-Thiago\resources\views/admin/stock_entries/index.blade.php ENDPATH**/ ?>