...
<div class="main-content w-full max-w-full flex flex-col items-center justify-start min-h-screen p-0" style="background: none;">
    <div class="w-full max-w-7xl mx-auto flex flex-col gap-6">
        <div class="flex flex-row items-center justify-between mt-8 mb-4">
            ...
            <a href="<?php echo e(route('suppliers.create')); ?>" class="btn">+ Novo Fornecedor</a>
        </div>
                ...
                <table class="table" style="background: rgba(30,32,48,0.98);">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td style="color: #fff; font-weight: 500;"><?php echo e($supplier->nome); ?></td>
                                <td style="color: #fff; font-weight: 500;"><?php echo e($supplier->documento); ?></td>
                                <td style="color: #fff; font-weight: 500;"><?php echo e($supplier->email); ?></td>
                                <td style="color: #fff; font-weight: 500;"><?php echo e($supplier->telefone); ?></td>
                                <td style="color: #fff; font-weight: 500;"><?php echo e($supplier->endereco); ?></td>
                                <td class="flex flex-row gap-2">
                                    <a href="<?php echo e(route('suppliers.show', $supplier->id)); ?>" class="table-action no-bg view">Ver</a>
                                    <a href="<?php echo e(route('suppliers.edit', $supplier->id)); ?>" class="table-action no-bg edit">Editar</a>
                                    <form action="<?php echo e(route('suppliers.destroy', $supplier->id)); ?>" method="POST" class="inline-block" onsubmit="return confirm('Confirma exclusão do fornecedor?')">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Desktop\Projeto-Thiago\resources\views/admin/suppliers/index.blade.php ENDPATH**/ ?>