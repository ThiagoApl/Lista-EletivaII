<aside class="relative w-64 bg-white shadow-lg h-screen flex flex-col justify-between p-4 sidebar">
    ...
    <div class="mt-6 pt-4 border-t border-gray-200">
        <div class="text-sm text-gray-100">
            ...
            <p class="text-xs text-gray-300"><?php echo e(Auth::user()->email); ?></p>
...
<?php /**PATH C:\Users\User\Desktop\Projeto-Thiago\resources\views/partials/sidebar.blade.php ENDPATH**/ ?>